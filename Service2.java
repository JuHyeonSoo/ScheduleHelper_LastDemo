...
public class Service2 extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Toast.makeText(getApplicationContext(), "자동 일정 추가 서비스를 시작합니다.", Toast.LENGTH_SHORT).show();
    ...
    private class  Counter implements Runnable {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(getApplicationContext())
                        ...
                        .setContentTitle("스케줄 자동 저장 기능")
                        .setContentText("정기적 일정으로 저장하고자 한다면, 클릭해 주세요.")
                        .setAutoCancel(true)
                        .setContentIntent(pi);
        ...
        @Override public void run() { for (count = 0; count < 5; count++) { // STOP 버튼을 눌렀다면 종료한다.
            ...
            handler.post(new Runnable() { @Override public void run() {
                ...
                if(count==0) {
                    ...
                    if((lat1==0)&&(lon1==0)){
                        Toast.makeText(getApplicationContext(), "Error: 위도, 경도 값 불분명, 잠시 후에 다시 시도해주세요.", Toast.LENGTH_SHORT).show();
                        isStop=true;
                        //db.close();
                    }
                }
                ...
                {
                    Toast.makeText(getApplicationContext(), "자동 일정 추가 서비스를 종료합니다.", Toast.LENGTH_SHORT).show();
                    isStop=true;
                    //db.close();
                }
...
/*
   ...
   */
                    ...
                    try {
                        ...
                        {
                            Toast.makeText(getApplicationContext(), "이 시간대에 이미 중복된 스케줄이 존재합니다", Toast.LENGTH_SHORT).show();
                            isStop = true;
                            Log.d("2", "2");
                            db.close();
                        }
                ...
                if(count==4)
                {
                    ...
                    */
                        ...
                        db.close();
                        Toast.makeText(getApplicationContext(), "일정을 추가하고자 하신다면 상단의 알림을 클릭해 주십시오.", Toast.LENGTH_LONG).show();
            ...
            db.close();
            //Toast.makeText(getApplicationContext(), "자동 일정 추가 서비스가 종료되었습니다.1", Toast.LENGTH_SHORT).show();
            } }); } }
                                    //3
