...
public class CalendarFragment extends Fragment implements MonthLoader.MonthChangeListener, WeekView.EventClickListener, WeekView.EventLongPressListener {
    ...
    public List<? extends WeekViewEvent> onMonthChange(int newYear, int newMonth) {
        ...
        //색 집합
        int[] event_color = new int[]{R.color.event_color1, R.color.event_color2, R.color.event_color3,
                R.color.event_color4, R.color.event_color5,R.color.event_color6,R.color.event_color7};
        //
        int color_count= 0;
        ...
        for (int traveler = 0; traveler<=sc_account; traveler++) {
            ...
            try{
                ...
                event.setColor(getResources().getColor(event_color[color_count]));
                events.add(event);
                c2.close();
//
                if(color_count==6){
